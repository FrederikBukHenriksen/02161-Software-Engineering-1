...
public class registerTime {
    ...
    public void user_register_time_from_to_to_activity_in_project(String userInitials, Integer yearStart,
        ...
        try {
            ...
            user.registerWork(projectPlanner.dateServer.createTimestamp(yearStart, monthStart, dateStart, hourStart, minuteStart),
                   projectPlanner.dateServer.createTimestamp(yearEnd, monthEnd, dateEnd, hourEnd, minuteEnd), activity);
        } catch (Exception e) {
